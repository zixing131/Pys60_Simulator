    ((268440334, 268450269), 268451882): (3, 0),
    ((268461335,), 268451890): (22, 0),
    ((268440334, 268450265), 268451882): (32, 0),
    ((268455416, 268450266), 268455406): (26, 2),
    ((270551984, 270553034, 268450266), 270553034): (36, 2),
    ((268455414, 268450267), 268455404): (27, 1),
    ((270551984, 270553033), 270551985): (38, 0),
    ((268440332, 268450266), 268451874): (10, 2),
    ((268455412,), 268455402): (23, 0),
    ((268440332,), 268451869): (25, 0),
    ((268440334, 268450265, 268450267), 268451882): (32, 1),
}
...
storagetypemap = {
    "text": _contacts.storage_type_text,
...
class ContactsDb(object):
    def __init__(self, dbfile=None, mode=None):
        ...
        self._raw_field_types = data[
            0
        ]  # list of id values of each template field [[new_id_1, .., new_id_n], ..]
        self._vcard_mappings = data[
            1
        ]  # vcard mappings for each template field [mapping_1, ..]
        self._simple_field_types = (
            []
        )  # list of self._raw_field_types[index][0] for all values of index.
        self._field_types = (
            []
        )  # [{"name":"field_default_label_1", "storagetype":"text", "type":"last_name", "location":"none"}, ..]
        self._template_field_schema = (
            {}
        )  # {template_field_index:{"name":"field_default_label_1", "storagetype":"text", "type":"last_name", "location":"none"}..}
        self._schema_index_map = (
            {}
        )  # ((new_id_1, .., new_id_n), vcard_mapping):schema_index_1, ..)
        self._nr_of_field_types = len(self._raw_field_types)
        for index in range(self._nr_of_field_types):
            self._schema_index_map[
                (tuple(self._raw_field_types[index]), self._vcard_mappings[index])
            ] = index
    ...
    def _field_type_pb_to_symbian(self, field_type, location):
        ...
        if (
            (location is None)
            or (location == locationmap["none"])
            or (location == locationmap[unknown_location])
        ):
            key = (field_type, locationmap["none"])
        else:
            key = (field_type, location)
        if key in _api_mappings_reverse_map:
            return _api_mappings_reverse_map[key]
        raise TypeError(
            "field type "
            + str(key)
            + " was not recognized. _api_mappings update needed?"
        )

    def _field_type_symbian_to_pb(
        self, new_field_type, vcard_mapping, storage_type="text"
    ):
        key = (tuple(new_field_type), vcard_mapping)
        if key in _api_mappings:
        ...
        warnings.warn(
            "new fieldtype "
            + str(key)
            + " not recognized. _api_mappings update needed?",
            RuntimeWarning,
        )
    ...
    def _field_schema(self, schemaid):
        ...
        old_field_type = self._field_type_symbian_to_pb(
            self._raw_field_types[schemaid],
            schema["vcard_mapping"],
            schema["storagetype"],
        )
        del schema["vcard_mapping"]
        schema["location"] = locationreversemap[old_field_type[1]]
        if old_field_type[0] in fieldtypereversemap:
        ...
        for item in vcard_match:
            ...
            for template_uid in self._raw_field_types[item]:
                if template_uid in field_uids:
                    match_count += 1
                if match_count == len(field_uids):
                    break
            if longest_match < match_count:
                longest_match = match_count
                found_index = item
                if longest_match == len(field_uids):
                    break
        if found_index >= 0:
            return found_index
        else:
    ...
    def _search_vcard_mapping(self, vcard_id):
        vcard_match = []
        for i in range(len(self._vcard_mappings)):
    ...
    def _determine_field_type(self, storage_type, field_uids, vcard_id, find_uids=None):
        ...
        if key in self._schema_index_map:
    ...
    def add_contact(self):
        return ContactsDb.Contact(
            self._db.create_entry(), self, locked="as_new_contact"
        )
    ...
    def _build_vcard_flags(
        self,
        include_x=0,
        ett_format=0,
        exclude_uid=0,
        decrease_access_count=0,
        increase_access_count=0,
        import_single_contact=0,
    ):
        vcard_flags = 0
        if include_x:
    ...
    def import_vcards(self, vcards, include_x=1, ett_format=1, import_single_contact=0):
        vcard_flags = self._build_vcard_flags(
            include_x, ett_format, 0, 0, 0, import_single_contact
        )
        return [
            self[x]
            for x in self._db.import_vcards(
                (vcards.decode("utf-8") if isinstance(vcards, bytes) else str(vcards)),
                vcard_flags,
            )
        ]
    ...
    def find(self, searchterm):
        return [
            self[x]
            for x in self._db.find(str(searchterm), tuple(self._simple_field_types))
        ]
    ...
    class Contact(object):
        ...
        def _get_title(self):
            first_name_indexes = self._contact.find_field_indexes(
                _contacts.given_name_value
            )
            last_name_indexes = self._contact.find_field_indexes(
                _contacts.family_name_value
            )
            title_str = ""
            for index in last_name_indexes:
                title_str += self._contact.get_field(index)["value"] + " "
        ...
        def find(self, type=None, location=None):
            if type:
                ...
                new_type = None
                try:
                    new_type = self.db._field_type_pb_to_symbian(
                        typecode, locationmap[location]
                    )
                except:
                    return (
                        []
                    )  # this combination of type and location is not recognized.
                ...
                for index in tmp_indices:
                    ...
                    if (new_type_ids == field_data["field_ids"]) and (
                        new_type[1] == field_data["vcard_mapping"]
                    ):
                        # exact match
                        indices.append(index)
                        continue
                    schema_index = self.db._determine_field_type(
                        field_data["storagetype"],
                        field_data["field_ids"],
                        field_data["vcard_mapping"],
                        new_type_ids,
                    )
                    if schema_index != None:
                        if (
                            new_type_ids == self.db._raw_field_types[schema_index]
                        ) and (new_type[1] == self.db._vcard_mappings[schema_index]):
                            indices.append(index)
                fields = []
                ...
                if location is not None:  # this is slow, but this should be a rare case
                    return [
                        x
                        for x in self
                        if locationmap[x.location] == locationmap[location]
                    ]
        ...
        def rollback(self):
            ...
            if self._locked == "as_new_contact":
                ...
                self._contact = self.db._db.create_entry()
            else:
    ...
    class ContactField(object):
        ...
        def _get_schema(self):
            ...
            schema_index = self.contact.db._determine_field_type(
                field_data["storagetype"],
                field_data["field_ids"],
                field_data["vcard_mapping"],
            )
            ...
            if schema_index not in list(self.contact.db._template_field_schema.keys()):
        ...
        label = property(
            lambda self: self.contact._contact.get_field(self.index)["label"],
            lambda self, x: self.contact._set(self.index, label=x),
        )
        value = property(
            lambda self: self.contact._contact.get_field(self.index)["value"],
        ...
        def __str__(self):
            return "<field #%d of %s: type=%s value=%s location=%s label=%s>" % (
                self.index,
                self.contact,
                self.type,
    ...
    class Group(object):
        ...
        def _set_name(self, newname):
            self._db._db.contact_group_set_label(self._group_id, str(newname))
