...
import base64,thread,os,random
...
class ithomeUi:
    def __init__(self):
        ...
        self.SlideIndex = 0
        self.nowtime=0
        self.__canvas = ui.Canvas(redraw_callback=self.redraw, event_callback=self.key)#self.key
    ...
    def main(self):
        ...
        self.nowtime = 0
        #self.__canvas.bind(63498,lambda:self.test())
        self.redraw1()
        self._lock_wait()
    def test(self):
        self.drawMain()
