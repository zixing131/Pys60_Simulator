...
var tbsettings = function(){
    this.clientType = '1',
	this.clientId = 'wappc_1362027349698_178'
}

var utility = function(){
    this.imei='123456789123456'
}
BaiduRequest.prototype.signForm = function(param){
            BaiduConst._client_type = tbsettings.clientType;
            BaiduConst._phone_newimei = getMd5(utility.imei+"0").toUpperCase();
            BaiduConst.cuid = getMd5(utility.imei).toUpperCase();
            ...
            var sign = getMd5(tmp).toUpperCase();
