    ...
    def WndProc(self, message, wparam, lparam):
        if message == WM_PAINT : 
            if self._change : 
                ...
                self.image.drawString((FONT, self._PushButton__size), self._PushButton__fcolor, self.left + (self.width / 2), self.top + (self.height / 2), self._PushButton__text, (glib.HCENTER | glib.VCENTER))
                self._change = False
    ...
    def WndProc(self, message, wparam, lparam):
        if message == WM_PAINT :
            if self._change : 
                ...
                self.image.drawString((FONT, self._SysLink__size), self.color, (self.left + 2), self.top + (self.height / 2), self._SysLink__text, (glib.LEFT | glib.VCENTER))
                self._change = False
    ...
    def WndProc(self, message, wparam, lparam):
        if message == WM_PAINT : 
            if self._change : 
                ...
                self.image.drawString((FONT, self._StaticText__size), self.color, self.left, self.top + (self.height / 2), self._StaticText__text, (glib.LEFT | glib.VCENTER))
                self._change = False
            pass
...
class StaticEdit(Window, ) :
    ...
    def drawText(self):
        ...
        for char in self._StaticEdit__text:
            ...
            if ord(char) < 19968 : 
                ...
                pass
            if char == u'\n' : 
                self.image.drawString((FONT, self._StaticEdit__size), self.color, (self.left + 5), self.top + y + self._StaticEdit__hei, sls, (glib.LEFT | glib.BOTTOM))
                sls = u''
                ...
                x += w
                self._StaticEdit__end += 1
        self.image.drawString((FONT, self._StaticEdit__size), self.color, (self.left + 5), self.top + y + self._StaticEdit__size, sls, (glib.LEFT | glib.BOTTOM))
        self._StaticEdit__num.append((self._StaticEdit__end - oldend))
        self._StaticEdit__index += 1
    ...
    def drawPrev(self):
        ...
        self.image.drawString((FONT, self._StaticEdit__size), self.color, (self.left + 5), (self.top + 5) + self._StaticEdit__hei, s, (glib.LEFT | glib.BOTTOM))
    ...
    def drawNext(self):
        ...
        if self._StaticEdit__index < (len(self._StaticEdit__num) - 1) : 
            ...
            s = s.replace(u'\r', u'').replace(u'\n', u'')
            self.image.drawString((FONT, self._StaticEdit__size), self.color, (self.left + 5), self.top + self._StaticEdit__maxh + self._StaticEdit__hei, s, (glib.LEFT | glib.BOTTOM))
            return None
        sls = u''
        x = 5
        while self._StaticEdit__end < self._StaticEdit__len : 
            ...
            if ord(char) < 19968 : 
                ...
                pass
            if char == u'\n' : 
                self.image.drawString((FONT, self._StaticEdit__size), self.color, (self.left + 5), self.top + self._StaticEdit__maxh + self._StaticEdit__hei, sls, (glib.LEFT | glib.BOTTOM))
                self._StaticEdit__end += 1
                break
            elif char == u'\r' : 
                self._StaticEdit__end += 1
        ...
        if message == WM_PAINT : 
            ...
            if self._Trackbar__bool : 
                if self._Trackbar__style == Trackbar.FOLLOW : 
                    ...
                    self._Trackbar__txt.drawString((FONT, self._Trackbar__size), self.color, x, 2, (self._Trackbar__format % self._Trackbar__minvalue + str(self._Trackbar__n * self._Trackbar__gap)), (glib.HCENTER | glib.TOP))
                    self.image.blit(self._Trackbar__txt, target = (self.left, (self.top + 20)))
                elif self._Trackbar__style == Trackbar.LEFT : 
                    self._Trackbar__txt.clear(self._Trackbar__bcolor)
                    self._Trackbar__txt.drawString((FONT, self._Trackbar__size), self.color, 0, 2, (self._Trackbar__format % self._Trackbar__minvalue + (self._Trackbar__n * self._Trackbar__gap)), (glib.LEFT | glib.TOP))
                    self.image.blit(self._Trackbar__txt, target = (self.left, (self.top + 20)))
                elif self._Trackbar__style == Trackbar.center : 
                    self._Trackbar__txt.clear(self._Trackbar__bcolor)
                    self._Trackbar__txt.drawString((FONT, self._Trackbar__size), self.color, (self.width / 2), 2, (self._Trackbar__format % self._Trackbar__minvalue + (self._Trackbar__n * self._Trackbar__gap)), (glib.HCENTER | glib.TOP))
                    self.image.blit(self._Trackbar__txt, target = (self.left, (self.top + 20)))
                elif self._Trackbar__style == Trackbar.RIGHT : 
                    self._Trackbar__txt.clear(self._Trackbar__bcolor)
                    self._Trackbar__txt.drawString((FONT, self._Trackbar__size), self.color, (self.width - 1), 2, (self._Trackbar__format % self._Trackbar__minvalue + (self._Trackbar__n * self._Trackbar__gap)), (glib.RIGHT | glib.TOP))
                    self.image.blit(self._Trackbar__txt, target = (self.left, (self.top + 20)))
                pass
